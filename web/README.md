# fuzztesting Web Dashboard

The fuzztesting Web Dashboard provides a modern, real-time interface for monitoring and managing your distributed fuzzing operations.
...
- Node.js 18+ and npm
- Running fuzztesting master server
...
```bash
# Build Docker image
docker build --target master -t fuzztesting-master .
...
Part of the fuzztesting project. See main repository for license details.