...
// Metrics holds all Prometheus metrics for the fuzztesting system
type Metrics struct {
	// HTTP metrics
	...
	return &Metrics{
		...
		HTTPRequestsTotal: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_http_requests_total",
		...
		HTTPRequestDuration: promauto.NewHistogramVec(
			prometheus.HistogramOpts{
				Name:    "fuzztesting_http_request_duration_seconds",
		...
		HTTPResponseSize: promauto.NewHistogramVec(
			prometheus.HistogramOpts{
				Name:    "fuzztesting_http_response_size_bytes",
		...
		BotHeartbeats: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_bot_heartbeats_total",
		...
		BotHeartbeatLatency: promauto.NewHistogramVec(
			prometheus.HistogramOpts{
				Name:    "fuzztesting_bot_heartbeat_latency_seconds",
		...
		BotTimeouts: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_bot_timeouts_total",
		...
		JobDuration: promauto.NewHistogramVec(
			prometheus.HistogramOpts{
				Name:    "fuzztesting_job_duration_seconds",
		...
		CrashesTotal: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_crashes_total",
		...
		UniqueCrashes: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_unique_crashes",
		...
		CoverageEdges: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_coverage_edges",
		...
		CoverageNewEdges: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_coverage_new_edges_total",
		...
		CorpusSize: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_corpus_size_bytes",
		...
		DatabaseQueries: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_database_queries_total",
		...
		DatabaseLatency: promauto.NewHistogramVec(
			prometheus.HistogramOpts{
				Name:    "fuzztesting_database_latency_seconds",
		...
		DatabaseErrors: promauto.NewCounterVec(
			prometheus.CounterOpts{
				Name: "fuzztesting_database_errors_total",
		...
		CircuitBreakerState: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_circuit_breaker_state",
		...
		CPUUsageGauge: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_cpu_usage_percent",
		...
		MemoryUsageGauge: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_memory_usage_bytes",
		...
		DiskUsageGauge: promauto.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "fuzztesting_disk_usage_bytes",
		...
		ActiveProcessesGauge: promauto.NewGauge(
			prometheus.GaugeOpts{
				Name: "fuzztesting_active_processes_total",
