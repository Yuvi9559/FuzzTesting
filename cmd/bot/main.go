...
import (
	...
	pkgconfig "github.com/Yuvi9559/FuzzTesting/pkg/config"
...
func main() {
	...
	}).Info("Initializing fuzztesting Bot")
	...
	}).Info("fuzztesting Bot started successfully")
	...
	logger.Info("fuzztesting Bot shutdown complete")
}
